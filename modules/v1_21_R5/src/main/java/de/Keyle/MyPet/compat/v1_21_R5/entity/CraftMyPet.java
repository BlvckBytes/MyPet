...
public class CraftMyPet extends CraftMob implements MyPetBukkitEntity {
	...
	protected de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPet petEntity;
	protected CraftEntityEquipment fakeEquipment;

	public CraftMyPet(CraftServer server, de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPet entityMyPet) {
	...
	@Override
	public de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPet getHandle() {
		return petEntity;
	}
