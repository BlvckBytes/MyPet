...
public class CraftMyPetPart extends CraftEntity implements MyPetBukkitPart {
    ...
    protected de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPetPart petEntity;

    public CraftMyPetPart(CraftServer server, de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPetPart entityMyPet) {
    ...
    @Override
    public de.Keyle.MyPet.compat.v1_21_R5.entity.EntityMyPetPart getHandle() {
        return petEntity;
    }
